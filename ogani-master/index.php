...
<body>
    ...
    <section class="featured spad" id="featured-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <?php
                            $p -> viewFeatureProductType();
                       ?>
                    </div>
                </div>
            </div>
            <div class="row featured__filter" id="featured__filter">
                <?php
                        if (isset($_REQUEST['btn-search'])){
                            $search = $p-> test_input($_REQUEST['search']);
                            // $search = $_REQUEST['search'];
                            $p -> viewSearchProduct($search);
                            } else {    
                                $p -> viewAllProduct();
                            }   
                        ?>
    ...
    $(document).ready(function() {
        ...
        $(".category").click(function() {
            ...
            var targetOffset = $(".section-title").offset().top;
