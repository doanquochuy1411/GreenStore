            ...
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="post">
                    ...
                    <div class="wrap-input100 ">
                        <input class="input100" type="password" name="newPassword" value="<?php echo $mkdefa; ?>"
                    ...
                    <div class="wrap-input100 ">
                        <input class="input100" type="password" name="renewPassword" value="<?php echo $remkdefa; ?>"
