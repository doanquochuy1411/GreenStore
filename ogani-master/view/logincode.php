...
$con = mysqli_connect("localhost","root","","raucu") or die("Can not connect to MySQL");
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Arimo&family=Public+Sans&family=Work+Sans&display=swap"
        rel="stylesheet">
    <title>Đăng ký </title>
</head>
